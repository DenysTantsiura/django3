...
class AuthorForm(ModelForm):
    ...
    # error_messages={'invalid': 'Enter date by format "dd.mm.YYYY"'}):
...
class QuoteForm(ModelForm):
    ...
    tags = ModelMultipleChoiceField(queryset=Tag.objects.all(), widget=CheckboxSelectMultiple)  # or Tag()
    # tags.cleaned_data = {:,:,}
